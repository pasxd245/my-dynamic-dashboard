...
| [`design/_css/tokens.css`](../../design/_archive/_css/tokens.css)                                                           | **Fully superseded**                                  | Preview-shell auxiliary. Consumer-check: zero live workspace consumers; R14 documents it as a _mirror_ of `themeTokens.ts` (live source lives in `workspace/`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
